...
3. **ConditionPending**: About to check pre-execution constraints
4. **ConditionRunning**: Actively checking pre-execution constraints
5. **ActionPending**: Pre-execution constraint violated, about to take action
6. **ActionRunning**: Taking action based on constraint violation
